  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      if (currentContent === 'projects') {
        ...
        const pos1 = screenToWorld(card1, 0, -95, -0.2); // Offset up to icon area
        const pos2 = screenToWorld(card2, 0, -95, -0.2);
        const pos3 = screenToWorld(card3, 0, -95, -0.2);
        ...
        const pos1 = screenToWorld(link1, -120, 0, -0.15); // Offset to the left
        const pos2 = screenToWorld(link2, -120, 0, -0.15);
        const pos3 = screenToWorld(link3, -120, 0, -0.15);
